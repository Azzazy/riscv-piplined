...
set rc [catch {
  ...
  write_bitstream -force -no_partial_bitfile RISCV_Top.bit 
  catch { write_sysdef -hwdef RISCV_Top.hwdef -bitfile RISCV_Top.bit -meminfo RISCV_Top.mmi -file RISCV_Top.sysdef }
